...
exports.HOVER_DOCS = void 0;
exports.findHoverDoc = findHoverDoc;
exports.HOVER_DOCS = {
    // ── Blocs structurels ──────────────────────────────────────────────────────
    'begin': {
 ...
 */
function findHoverDoc(word) {
    // Recherche directe
    if (exports.HOVER_DOCS[word]) {
        return exports.HOVER_DOCS[word];
    }
    // Recherche insensible à la casse
    const lower = word.toLowerCase();
    for (const key of Object.keys(exports.HOVER_DOCS)) {
        if (key.toLowerCase() === lower) {
            return exports.HOVER_DOCS[key];
        }
    }
    return undefined;
}
//# sourceMappingURL=hover-docs.js.map